...
```mermaid
flowchart LR
    A["Investor Capital ₱100 M"] --> B["Platform Build & Pilot – Year 1"]
    B --> C["Break-Even ≈ 24 months (770 k tx / month)"]
    C --> D["National Rollout & Profitability – Year 3"]
    D --> E["Regional Expansion & Exit – Year 5"]
    E --> F["ROI ≈ 1.5× | IRR ≈ 21 %"]
```
